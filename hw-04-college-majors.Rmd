...
4.  Based on the shape of the histogram you created in the previous exercise, determine which of these summary statistics is useful for describing the distribution. I would argue the median is a good statistic for describing the distribution
...
```{scatterplot}
ggplot(college_majors, aes(x = sharewomen, y = median, color = major_category_stem)) +
  geom_point(alpha = 0.6) +
  labs(
    title = "Median Income vs. Proportion of Women by STEM Status",
